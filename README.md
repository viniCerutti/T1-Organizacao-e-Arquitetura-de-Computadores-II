# Descrição #
Trabalho I da Disciplina Organização e Arquitetura de Computadores II - 2017/2 PUCRS Ministrada pelo professor [Ney Calazans](http://www.inf.pucrs.br/calazans/) . O trabalho possui o objetivo de desenvolver a parte de comunição entre a CPU(MIPS) com o periferico (Lógica de Cola) e o  também o desenvolvimento do periferico.
